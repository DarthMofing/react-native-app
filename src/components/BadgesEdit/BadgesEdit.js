    ...
    return(
      <ScrollView style={styles.container}>
        <View style={styles.content}>
          ...
          <Image style={styles.profileImage} source={{uri:`${badge.profile_pic}`}}/>
          <View style={styles.form}>
            ...
            <TextInput style={styles.input} placeholder={badge.followers ? `${badge.followers}` : '0'} 
              onChangeText={text =>{
                this.setState(prevState => {
                  let form = Object.assign({},prevState.form)
                  form.followers = text
            ...
            <TextInput style={styles.input} placeholder={badge.likes ? `${badge.likes}` : '0'} 
              onChangeText={text =>{
                this.setState(prevState => {
                  let form = Object.assign({},prevState.form)
                  form.likes = text
            ...
            <TextInput style={styles.input} placeholder={badge.posts ? `${badge.posts}` : '0'} 
              onChangeText={text =>{
                this.setState(prevState => {
                  let form = Object.assign({},prevState.form)
                  form.posts = text
